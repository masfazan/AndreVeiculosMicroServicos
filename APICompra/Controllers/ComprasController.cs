...
namespace APICompra.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ComprasController : ControllerBase
    {
        private readonly APICompraContext _context;

        public ComprasController(APICompraContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Compra>> PostCompra(Compra compra)
        {
          if (_context.Compra == null)
          {
              return Problem("Entity set 'APICompraContext.Compra'  is null.");
          }
