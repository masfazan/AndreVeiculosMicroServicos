...
namespace APIEndereco.Controllers
{
    ...
    {
        private readonly APIEnderecoContext _context;

        public EnderecoesController(APIEnderecoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Endereco>> PostEndereco(Endereco endereco)
        {
          if (_context.Endereco == null)
          {
              return Problem("Entity set 'APIEnderecoContext.Endereco'  is null.");
          }
